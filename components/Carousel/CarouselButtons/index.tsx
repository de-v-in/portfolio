...
export const DotButton: IComponent<DotButtonProps> = ({
  selected,
  onClick,
}) => (
  <button
    className={`${styles.embla__dot}  ${selected ? styles.isSelected : null}`}
    type="button"
    onClick={onClick}
  />
);

export const PrevButton: IComponent<PrevButtonProps> = ({
  enabled,
  onClick,
}) => (
  <button
...
export const NextButton: IComponent<NextButtonProps> = ({
  enabled,
  onClick,
}) => (
  <button
